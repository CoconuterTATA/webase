export default {
    login: {
        ...
        ForgetPasswordMsg:'如忘记密码，请在在线文档中搜索',
        VerificaFailedMsg:"如验证码加载失败，请检查服务的网络端口是否开放，详情可在在线文档中搜索",
    ...
    text: {
        ...
        agreeNode_7: "详情可参考右上角的帮助文档-管理平台使用手册-附录-动态群组管理使用指南",
        ...
        readyAnsibleInfo: "需要在Node-Manager中所在机器安装Ansible，并为Ansible配置私钥",
        ...
        appStep11: '通过服务注册获得注册信息，并通过API向区块链数字身份应用管理台注册服务',
        appStep12: '通过区块链数字身份应用管理台提供的基础能力API和区块链数字身份应用管理台连通',
        appStep21: '添加应用',
        appStep22: '启动应用插件',
        appStepTag1: '链上账号信息',
        appStepTag2: '链信息和链配置',
        appStepTag3: '管理账号',
        appStepTag4: '合约',
        appDescContent: '应用管理功能是区块链数字身份应用管理台提供的一种应用管理插件接入功能——区块链数字身份应用管理台提供应用管理功能菜单，并提供接入通用性规范。各个应用可以按照接入规范注册到区块链数字身份应用管理台，以此来实现区块链数字身份应用管理台和各应用之间从用户，区块链账户，基础配置，合约等方面实现连通。',
        copyInfo: '复制信息',
    ...
    nodes: {
        ...
        guidetep2: "选择区块链版本，填写Base-Sign的地址，最后再填写主机信息：包括主机IP，主机部署节点数量，主机所属机构，节点所属群组和区块链数据存储目录。",
        ...
        newVersion: "获取最新版本",
        webaseSignAdr: "Base-Sign的地址",
        addressError: "地址格式不正确",
        webaseSghAdrInfo: "Base-Sign的地址，例：127.0.0.1:6004",
        hostList: "主机列表",
    ...
    guide: {
        guidePage: "引导页",
        addFront: "添加节点前置",
        addFrontTip1: "节点前置和节点绑定的一个java服务的中间件，集成web3jsdk，Base平台通过该服务连接节点。",
