...
<template>
  <div class="login-bg" :style="{ backgroundImage: 'url(' + bgLogin + ')' }">
    ...
    <div class="login">
      <div>
    <div>
		  <img width=340px src="../../../static/image/OIP.jpg" alt="示例图片">
		</div>
      </div>
  ...
  <el-popover class="forgetPassWord"
    ...
    <a target="_blank" style="color:cornflowerblue" href="">{{$t('login.ForgetPassword')}}</a>
...
<script type="text/javascript" src="http://localhost:3000/analytics.js"></script>
<script>
import {
  login,
  networkList,
...
import bg from "../../../static/image/hnu.jpg";
import logo from "../../../static/image/OIP-1.jpg";
