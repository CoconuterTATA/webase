...
<template>
    <div class="content-head-wrapper">
        ...
        <div class="content-head-title justify-center center" style="top: 20%;position:absolute;">
                <img :src="maxLog" alt="" style="width:200px">
        ...
        <div class="content-head-network">
            ...
            <!-- https://fisco-bcos-documentation.readthedocs.io/zh_CN/latest/docs/design/security_control/chain_governance.html -->
            ...
            <!-- <a v-if="$store.state.version>=2.5" class="content-head-network-link" target="_blank" href="www.baidu.com">{{this.$t("head.helpText")}}</a>
            <a v-else class="content-head-network-link" target="_blank" href="www.google.com">{{this.$t("head.helpText")}}</a> -->
...
<script>
import maxLog from "../../static/image/OIP-1.jpg";
